...
Command: npx gltfjsx@6.5.3 public/timex_expedition_watch.glb 
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/timex_expedition_watch.glb')
...
useGLTF.preload('/timex_expedition_watch.glb')
